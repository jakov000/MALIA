    ...
    <div className="bg-white">
      ...
      <section className="py-24 md:py-40 px-6 max-w-7xl mx-auto">
        ...
        <div className="mt-20 pt-20 border-t border-stone-100 text-center">
          <h3 className="text-2xl font-serif italic mb-6">Der See im Winter</h3>
          <p className="max-w-3xl mx-auto text-gray-600 font-light leading-relaxed mb-12">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-16 text-sm text-gray-600 font-light leading-relaxed">
            <div className="space-y-6">
              ...
              <a href="#" className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest border-b border-stone-300 pb-1">→ Wanderführer Achensee entdecken</a>
            </div>
            <div className="space-y-6">
              ...
              <a href="#" className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest border-b border-stone-300 pb-1">→ Golfclub Achensee entdecken</a>
            </div>
            <div className="space-y-4">
      ...
      <section className="py-24 md:py-40 px-6 text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-xl md:text-2xl font-serif uppercase tracking-[0.3em] mb-8">Interaktive Karte</h2>
          <h3 className="text-lg font-serif italic mb-6">Orientierung, ganz entspannt</h3>
      ...
      <section className="py-24 md:py-40 px-6 bg-stone-50/30">
        <div className="max-w-4xl mx-auto text-center space-y-10">
          <h2 className="text-xl md:text-3xl font-serif uppercase tracking-[0.2em]">Atoll Achensee</h2>
